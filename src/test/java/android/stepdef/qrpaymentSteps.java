...
public class qrpaymentSteps extends TestBase {
    ...
    public void iTransferToOtherAccountByQRWithAmountAndDescriptionWithFeePayerIs(String amount, String description, String feePayer) throws Throwable {
        ...
        androidDriver.findElement(By.xpath("//android.widget.TextView[@text='Bộ sưu tập']")).click();
        Thread.sleep(1000);
        scrollToUp();
        androidDriver.findElement(By.xpath("//android.widget.TextView[@text='QR_UserLive']")).click();
        androidDriver.findElement(By.xpath("//android.widget.ImageView[@index='0']")).click();
    ...
    public void iCreateQRPersonalInformation() throws Throwable {
        ...
        waitElement(By.xpath("//android.widget.LinearLayout[@index='0']/android.widget.FrameLayout[@index='1']"));
        androidDriver.findElement(By.xpath("//android.widget.LinearLayout[@index='0']/android.widget.FrameLayout[@index='1']")).click();
    }
    ...
    public void iPayByQR() throws Exception {
        ...
        Thread.sleep(1000);
        scrollToUp();
        androidDriver.findElement(By.xpath("//android.widget.TextView[@text='QR_ShopLive']")).click();
        androidDriver.findElement(By.xpath("//android.widget.ImageView[@index='0']")).click();
    }
